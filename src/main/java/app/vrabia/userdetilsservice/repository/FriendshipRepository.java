...
public interface FriendshipRepository extends JpaRepository<Friendship, String> {
    ...
    List<Friendship> findByUser1_Id(String userId);

    Page<Friendship> findByUser1_IdAndUser2_NameContainingIgnoreCase(String user, String name2, Pageable pageable);
